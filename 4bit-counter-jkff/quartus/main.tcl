...
# File: jkff_counter4_proj.tcl
# Generated on: Sun Nov 30 17:41:55 2025
...
set project_name "jkff_counter4_proj"
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY jk_4bit_counter
	...
	# ==================================================
	set_global_assignment -name VHDL_FILE src/jk_ff.vhd -hdl_version VHDL_2008
	set_global_assignment -name VHDL_FILE src/jk_4bit_counter.vhd -hdl_version VHDL_2008
	set_global_assignment -name VHDL_FILE src/hex7seg_display.vhd -hdl_version VHDL_2008
	set_global_assignment -name VHDL_FILE src/button_debouncer.vhd -hdl_version VHDL_2008
	set_global_assignment -name BDF_FILE src/top_jk_counter.bdf
	set_global_assignment -name VHDL_FILE src/tb_jk_4bit_counter.vhd -hdl_version VHDL_2008
	...
	# ==================================================
	# Testbench (Default: tb_twoff)
	# ==================================================
	set testbench_top_name "tb_jk_4bit_counter"
