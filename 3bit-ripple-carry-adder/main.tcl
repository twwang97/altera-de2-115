...
set project_name "ripple_adder_3bit_proj"
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY adder3
	...
	set_global_assignment -name VERILOG_FILE src/adder3.v -hdl_version Verilog_2001
	set_global_assignment -name VHDL_FILE src/tb_adder3.vhd -hdl_version VHDL_2008
	...
	# ==================================================
	# Testbench (Default: tb_adder3)
	# ==================================================
	set testbench_top_name "tb_adder3"
