-- =============================================================================
-- File        : tb_mealy.vhd
-- Title       : Testbench for mealy_detect_01 (Mealy FSM)
-- Author      : twwang97
-- Date        : 2025-11-22
-- Description : Self-contained testbench that instantiates mealy_detect_01,
...
architecture tb of tb_mealy is
    ...
    signal detect_mealy  : std_logic;        -- DUT output

    -- component declarations (match the Verilog module port names)
	 component mealy_detect_01
	     port (
	         clk    : in  std_logic;
	         rst_n  : in  std_logic;
