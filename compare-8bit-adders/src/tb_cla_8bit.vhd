-- file: tb_cla_8bit.vhd
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;

entity tb_cla_8bit is
end entity tb_cla_8bit;

architecture tb of tb_cla_8bit is
    ...
    component sequential_trigger_cla8
      port (
		  clk         : in  std_logic;
		  rst_n       : in  std_logic;
		  start       : in  std_logic;
...
begin
    ...
    begin
        ...
        --------------------------------------------------------------------------
        -- Vector 2: 0x7FFFFFFFFFFFFFFF + 0x7FFFFFFFFFFFFFFF, cin=1
        --------------------------------------------------------------------------
        wait until rising_edge(clk);
        while busy = '1' loop
            wait until rising_edge(clk);
        ...
        --------------------------------------------------------------------------
        -- Vector 3: 0xFFFFFFFFFFFFFFFF + 0x0000000000000001, cin=0
        --------------------------------------------------------------------------
        wait until rising_edge(clk);
        while busy = '1' loop
            wait until rising_edge(clk);
